    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <x-maz-sidebar-menu title="Permohonan" icon="bi bi-grid-1x2-fill" active="{{ Route::is('test') }}">
                    <x-maz-submenu-item title="Permohonan Baru" link="{{ route('test') }}"
                        active="{{ Route::is('test') }}" />
                </x-maz-sidebar-menu>
